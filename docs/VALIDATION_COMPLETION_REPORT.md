...
| 13 | Solar Open 100B | NVFP4 / 56.0GiB | 🔄 진행 중 | — | — | — | 한국어 도메인 기대주(§19.11 예정) |

**핵심 요약**: 13개 검증 중 11개 성공·1개 실패(MLA)·1개 진행 중. 품질 만점(7/7)은 gpt-oss·Nemotron·
GLM·Gemma4·Coder-Next 5개. **종합 우위는 여전히 gpt-oss**(품질+처리량+생태계), 승격 도전자는
**Nemotron**(에이전트 품질·초장문), 특수 목적 후보는 **Coder-Next**(코딩)·**Gemma4**(경량).
